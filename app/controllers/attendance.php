...
class Attendance extends Controller {
	...
	// Sinh vien diem danh
	// public function list_attendance_student($class_id, $subject_id, $teacher_id) {
	// 	$AttendanceModelObj = $this->model('AttendanceModel');
	// 	$result = $AttendanceModelObj->get_list_attendance_student($class_id, $subject_id, $teacher_id);
	...
	public function check_exist_in_take_leave($class_id = null, $subject_id = null, $current_date = null, $attendance_id_last = null) {
		if($_SERVER['REQUEST_METHOD'] == 'GET') {
			$attendance = $this->model('AttendanceModel');
			$data = $attendance->get_check_exist_in_take_leave($class_id, $subject_id, $current_date, $attendance_id_last);
			exit(json_encode($data));
		}
	}
